  ...
  return (
    <section id="about" className="py-20 bg-gray-100">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center mb-12">About MindSpark</h2>
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-xl mb-8">
            MindSpark was founded with a simple mission: to democratize Discord bot creation. We believe that everyone
